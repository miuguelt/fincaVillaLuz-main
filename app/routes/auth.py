...
def login():
    ...
    set_access_cookies(response, access_token, domain="finca.isladigital.xyz", secure=True)
    set_refresh_cookies(response, refresh_token, domain="finca.isladigital.xyz", secure=True)
    return response
